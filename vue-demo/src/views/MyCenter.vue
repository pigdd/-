...
export default {
   ...
   updatepassword(){
       if(this.password != this.password2){
           ...
           return this.$ajax.post("/routes/user/updatepassword",obj)
           .then((res) => {
             if(res.ok){
              console.log("更新失败")              
             }else{
    ...
    updatephone(){
        ...
        this.phone=''
         ...
         const obj = {
           ...
           return this.$ajax.post("/routes/user/updatePhone",obj)
           .then((res) => {
             if(res.ok){
              console.log("更新失败")              
             }else{
       ...
       if(!(/^([a-zA-Z]|[0-9])(\w|\-)+@[a-zA-Z0-9]+\.([a-zA-Z]{2,4})$/.test(this.email))){ 
        ...
        this.email = "";
         ...
         const obj = {
           ...
           return this.$ajax.post("/routes/user/updateEmail",obj)
           .then((res) => {
             if(res.ok){
              console.log("更新失败")              
             }else{
